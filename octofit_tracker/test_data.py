...
test_data = {
    ...
    "activities": [
        {"_id": ObjectId(), "user": None, "activity_type": "Cycling", "duration": "1:00:00"},
        {"_id": ObjectId(), "user": None, "activity_type": "Crossfit", "duration": "2:00:00"},
        {"_id": ObjectId(), "user": None, "activity_type": "Running", "duration": "1:30:00"},
        {"_id": ObjectId(), "user": None, "activity_type": "Strength", "duration": "0:30:00"},
        {"_id": ObjectId(), "user": None, "activity_type": "Swimming", "duration": "1:15:00"},
    ],
    "leaderboard": [
